...
})({"8nAkL":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d8ce3d2348fe174f";
"use strict";
...
},{}],"dYxtp":[function(require,module,exports) {
var _headerComponent = require("./scripts/HeaderComponent");
var _waitlistModal = require("./scripts/WaitlistModal");
const waitlistModal = new (0, _waitlistModal.WaitlistModal)();
const headerInstance = new (0, _headerComponent.HeaderComponent)();
...
Array.from(document.querySelectorAll(".waitlist-button")).forEach((el)=>{
    el.addEventListener("click", ()=>{
        if (window.innerWidth <= 778) headerInstance.toggleModal();
        else waitlistModal.open();
    });
});

},{"./scripts/HeaderComponent":"i23Ar","./scripts/WaitlistModal":"4wBHL"}],"i23Ar":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "HeaderComponent", ()=>HeaderComponent);
var _waitlistProvider = require("./WaitlistProvider");
class HeaderComponent {
    provider = new (0, _waitlistProvider.WaitlistProvider)(".header-form");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./WaitlistProvider":"3DPDB"}],"gkKU3":[function(require,module,exports) {
...
},{}],"3DPDB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WaitlistProvider", ()=>WaitlistProvider);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4wBHL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WaitlistModal", ()=>WaitlistModal);
var _waitlistProvider = require("./WaitlistProvider");
class WaitlistModal {
    constructor(){
        this.el = document.getElementById("waitlist-modal");
        this.provider = new (0, _waitlistProvider.WaitlistProvider)("#waitlist-modal");
        this.el.addEventListener("click", ()=>this.close());
        this.el.querySelector(".modal-body").addEventListener("click", (e)=>e.stopPropagation());
    }
    close() {
...
},{"./WaitlistProvider":"3DPDB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8nAkL","dYxtp"], "dYxtp", "parcelRequire94c2")

//# sourceMappingURL=index.48fe174f.js.map
